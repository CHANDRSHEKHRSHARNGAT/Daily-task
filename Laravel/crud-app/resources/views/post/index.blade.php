...
<div class="row g-4 mt-1">
  ...
  <div class="col-lg-4">
      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          ...
          <div class="card-title fw-bold text-primary h5">{{ $row->title }}</div>
          <div class="card-title fw-bold h6">{{ $row->price }}</div>
  ...
  @empty
    <h2 class="text-center text-secondary p-4">No product found in the database!</h2>
  @endforelse
