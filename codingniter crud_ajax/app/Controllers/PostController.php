...
class PostController extends BaseController {
    ...
    public function fetch() {
        ...
        if ($posts) {
                ...
                <div class="card shadow-sm">
                  ...
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="badge bg-dark">' . $post['email'] . '</div>
                    </div>
                    <p>
                      ' . substr($post['phone'], 0, 80) . '
                    </p>
                  </div>
            ...
            return $this->response->setJSON([
                'error' => false,
                'message' => '<div class="text-secondary text-center fw-bold my-5">No profile found in the database!</div>'
            ]);
        }
    }
