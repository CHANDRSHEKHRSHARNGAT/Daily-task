...
<head>
  ...
  <title>Chandrashekhar sharnagat</title>
...
<body>
      ...
      <div class="modal-content">
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="add_post_form" novalidate>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" id="add_post_btn">Add Profile</button>
          </div>
        </form>
      </div>
    </div>
        ...
        <form action="#" method="POST" enctype="multipart/form-data" id="edit_post_form" novalidate>
          ...
          <div class="modal-body p-5">
            ...
            <div class="mb-3">
              ...
              <div class="invalid-feedback">Profile Email is required!</div>
            </div>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary" id="edit_post_btn">Update Profile</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <div class="modal fade" id="detail_post_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Details of Profile</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <img src="" id="detail_post_image" class="img-fluid">
        Profile Name <h3 id="detail_post_name" class="mt-3"></h3>
        Email <h4 id="detail_post_email"></h4>
         Phone <p id="detail_post_phone"></p>
          <p id="detail_post_created"> </p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        </div>
      ...
      <div class="col-lg-12">
        <div class="card shadow">
          <div class="card-header d-flex justify-content-between align-items-center">
            <div class="text-secondary fw-bold fs-3">Registration Form</div>
            <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#add_post_modal">Add New Profile</button>
          </div>
          <div class="card-body">
            <div class="row" id="show_posts">
              <h1 class="text-center text-secondary my-5">Profile Loading..</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      $(document).delegate('.post_detail_btn', 'click', function(e) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            $("#detail_post_name").text(response.message.name);
            $("#detail_post_email").text(response.message.email);
            $("#detail_post_phone").text(response.message.phone);
